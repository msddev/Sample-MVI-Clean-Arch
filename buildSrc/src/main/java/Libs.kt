...
object ComposeLib {
    ...
    const val MaterialIconExtended = "androidx.compose.material:material-icons-extended:1.3.0"
...
object NavigationLib {
    ...
    const val DestinationCore = "io.github.raamcosta.compose-destinations:core:1.8.33-beta"
    const val DestinationKsp = "io.github.raamcosta.compose-destinations:ksp:1.8.33-beta"
    const val DestinationAnimation =
        "io.github.raamcosta.compose-destinations:animations-core:1.8.33-beta"
}
